...
```{r plot, fig.width=10}
hotels %>%
  mutate(arrival_date_month = fct_relevel(arrival_date_month, month.name)) %>%  #reoder months to be in order
...
#if labels or points are overlapping you can use dodge function (google it)
```
